...
export function resolveServerUrl(ctx: CliContext, config: LocalConfig, flagValue?: string): string {
  const value =
...
export function resolveMirrorDir(ctx: CliContext, config: LocalConfig, flagValue?: string): string {
